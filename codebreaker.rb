...
# ========================
# 0. Remove the first character in the code. Using slice and index0 to remove 1st character. slice! is to remove the actual character from string "code" itself.
code.slice!(0)
# 1. Insert the string "A EW? O" at the code's 11th position. Using insert method.
code.insert(11,"A EW? O")
# 2. Remove all instances of the characters 'Q', '?', and ','. Using delete method.
code.delete!("Q?,")
# 3. STOP SHOUTING. Make the entire code lowercase, for now. Using downcase method.
code.downcase!
# 4. Reverse the order of the characters in the code. Using reverse method.
code.reverse!
# 5. Capitalize the first letter of the code. Using the capitalize method.
code.capitalize!
# 6. `puts` the code to reveal the message.
puts code
